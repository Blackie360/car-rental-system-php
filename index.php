...
<!-- Banners -->
<section id="banner" class="banner-section bg-blue-500">
  <div class="container">
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Comprehensive Vehicle Selection: Explore our extensive fleet of cars, ranging from compact cars to luxury vehicles, ensuring you find the perfect ride for your needs.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active" style="background-color: darkgreen;"><a href="#resentnewcar" role="tab" data-toggle="tab">New Car</a></li>
        </ul>
      </div>
