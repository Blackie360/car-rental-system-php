...
function MM_validateForm() { //v4.0
  ...
  for (i=0; i<(args.length-2); i+=3) { test=args[i+2]; val=MM_findObj(args[i]);
    ...
    } } } else if (test.charAt(0) == 'R') errors += '- '+nm+' is requiblue.\n'; }
  } if (errors) alert('The following error(s) occurblue:\n'+errors);
		...
		<div class="content-wrapper">
			...
			?>
									...
									<div class="form-group">
												...
												<div class="col-sm-8">
			<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Package Details" requiblue>
										<?php 
$pagetype=$_GET['type'];
