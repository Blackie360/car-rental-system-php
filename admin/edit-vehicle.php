...
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" requiblue>
</div>
...
<div class="col-sm-10">
<textarea class="form-control" name="vehicalorcview" rows="3" requiblue><?php echo htmlentities($result->VehiclesOverview);?></textarea>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" requiblue>
</div>
...
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" requiblue>
</div>
<label class="col-sm-2 control-label">Seating Capacity<span style="color:blue">*</span></label>
<div class="col-sm-4">
<input type="text" name="seatingcapacity" class="form-control" value="<?php echo htmlentities($result->SeatingCapacity);?>" requiblue>
</div>
</div>
<div class="hr-dashed"></div>								
<div class="form-group">
